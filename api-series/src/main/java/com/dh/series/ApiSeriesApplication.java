...
public class ApiSeriesApplication {
    ...
    public CommandLineRunner loadData(SerieRepository serieRepository) {
        ...
        return (args) -> {
            ...
            serieRepository.save(new Serie(uuid.toString(), "Serie 2", "Terror", temporadas));
            serieRepository.save(new Serie(uuid.toString(), "Serie 3", "Comedia", temporadas));
            serieRepository.save(new Serie(uuid.toString(), "Serie 4", "Ficcion", temporadas));
        };
    }
